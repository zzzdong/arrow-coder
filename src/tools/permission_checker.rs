...
use crate::tools::permissions::{
    ApprovalResponse, ApprovalType, ApprovedRule, PermissionContext, PermissionScope, RequiredPermission
};
...
pub struct PermissionChecker {
    config: VibeConfig,
    store: std::sync::Mutex<crate::tools::permissions::PermissionStore>,
}
...
impl PermissionChecker {
    pub fn new(config: VibeConfig) -> Self {
        Self {
            config,
            store: std::sync::Mutex::new(crate::tools::permissions::PermissionStore::new()),
        }
    }
